        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="comment-section-title section-title-style-02">
                    <h3 class="title">{{__('Leave a Comment')}}</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="btn-wrapper">
                                <button type="submit" class="btn-default" id="post-comment-btn">{{__('Post Comment')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    @guest('admin')
        ...
        <div class="">
            <a class="review-login" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter">
                ...
                {{__('Please login to write a comment')}}</a>
        </div>
    @endguest
@endguest

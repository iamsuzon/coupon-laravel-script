<div class="topbar-area bg-color-a">
                                        ...
                                        <li class="dashboard-mobile-btn">
                                            <div class="btn-wrapper">
                                                <a href="<?php echo e($route); ?>"
                                                   class="btn-default btn-outline register"> <?php echo e(__('Dashboard')); ?> </a>
                                            </div>
                                        </li>
                                    <?php else: ?>
...
<?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon-final/@core/resources/views/frontend/partials/pages-portion/supports/support-01.blade.php ENDPATH**/ ?>
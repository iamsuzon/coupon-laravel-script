                                ...
                                <div class="img-box">
                                    ...
                                    <?php if($deal->discount): ?>
                                        <div class="coupon-code-01">
                                            ...
                                            <div class="code">
                                                <span class="text"><?php echo e(__('Apply Coupon Code')); ?></span>
                                                <span class="main-code"><?php echo e($deal->coupon_code); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
...
</div><?php /**PATH E:\XAMPP\htdocs\coupon\@core\app\Providers../../PageBuilder/views/home/home_page_popular_offer.blade.php ENDPATH**/ ?>
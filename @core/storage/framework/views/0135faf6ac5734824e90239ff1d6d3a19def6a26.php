...
<?php $__env->startSection('page-title'); ?>
    <h2 class="list-item font-weight-bold"><a href="#"><?php echo e($category->title); ?></a></h2>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('page-meta-data'); ?>
    ...
    <?php echo render_site_title($category->title); ?>
                            ...
                            <div class="content">
                                <div class="top-content">
                                    <div class="left-content">
                                        ...
                                        <div class="details">
                                            <a href="<?php echo e(route_single_brand(optional($product->brand)->slug)); ?>"
                                               class="title" tabindex="0"><?php echo e(optional($product->brand)->title); ?></a>
                                    ...
                                    <div class="right-content">
                                        <?php if(get_product_rating_average($product->id) > 0): ?>
                                            ...
                                            <div class="rating-count">(<?php echo e(count($product->reviews)); ?>)</div>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon/@core/resources/views/frontend/category.blade.php ENDPATH**/ ?>
                            ...
                            <table class="table table-default">
                                ...
                                <?php $__currentLoopData = $all_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e(get_attachment_image_by_id($data->image,null,true)['img_url']); ?>" alt="" style="width: 50px;height: auto">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-category-delete')): ?>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover-all-lang','data' => ['url' => route('admin.product.category.delete.all.lang',$data->id)]]); ?>
<?php $component->withName('delete-popover-all-lang'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.product.category.delete.all.lang',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="<?php echo e(route('admin.product.category.store')); ?>" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="lug"><?php echo e(__('Slug')); ?> <sup
        ...
        <div class="modal fade" id="category_edit_modal" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.product.category.update')); ?>" method="post" id="category_edit_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="edit_slug"><?php echo e(__('Slug')); ?> <sup
                                            style="font-size: 10px">optional</sup></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/coupon/@core/resources/views/backend/product/category.blade.php ENDPATH**/ ?>
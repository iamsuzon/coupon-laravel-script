        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-wrapper style-01">
                    ...
                    <div class="to-top-row-right main-color-one" id="test_03"></div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="slick-main global-slick-init arrow-style-02" data-infinite="true" data-arrows="true"
                     ...
                     data-autoplay="true" data-autoplaySpeed="2500" data-appendArrows="#test_03"
                ...
                {"breakpoint": 768, "settings": {"slidesToShow": 1}}
                    ...
                    <div class="slick-item">
                        <div class="single-testimonial-item style-03">
                            <div class="quote">
...
</div><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon-final/@core/app/Providers/../PageBuilder/views/home/home_page_customer_review_style_one.blade.php ENDPATH**/ ?>
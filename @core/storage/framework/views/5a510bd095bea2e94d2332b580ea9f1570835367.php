...
<?php endif; ?>
                                                    ...
                                                    <div class="thumbnail">
                                                        <div class="centered">
                                                            <img class="avatar user-thumb"
                                                                 src="<?php echo e($blog_img['img_url']); ?>" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <span class="<?php echo e($colors[random_int(0,4)]); ?>"><?php echo e($data->category->getTranslation('title',$default_lang,true)); ?></span>
                                        </td>
...
<?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-trashed-restore')): ?>
                                                <a class="btn btn-lg btn-primary btn-sm mb-3 mr-1"
                                                   href="<?php echo e(route('admin.blog.trashed.restore',$data->id)); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/coupon/@core/Modules/Blog/Resources/views/backend/blog/trashed.blade.php ENDPATH**/ ?>
...
<div class="error-area-wrapper" data-padding-top="100" data-padding-bottom="100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="img-box">
                    <h4 class="title mt-5"><?php echo e(get_static_option('error_404_page_'.get_user_lang().'_subtitle')); ?></h4>
...
</html><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon/@core/resources/views/errors/404.blade.php ENDPATH**/ ?>
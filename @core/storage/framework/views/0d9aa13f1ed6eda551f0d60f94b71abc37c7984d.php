                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.reading')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                <label for="site_logo"><?php echo e(__('Product Page Display')); ?></label>
                                <select name="product_page" class="form-control">
                                    <?php $__currentLoopData = $all_home_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($page->id); ?>" <?php if($page->id == get_static_option('product_page')): ?>  selected <?php endif; ?> ><?php echo e($page->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon/@core/resources/views/backend/general-settings/reading.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Product Location')); ?>
                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title"><?php echo e(__('All Location')); ?>  </h4>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-location-delete')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                            ...
                            <div class="header-title d-flex">
                                <div class="btn-wrapper-inner">
                                    <form action="<?php echo e(route('admin.product.location')); ?>" method="get"
...
<?php endif; ?>
                                ...
                                <div class="btn-wrapper-inner ml-2">
                                    <button class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#location_add_modal"><?php echo e(__('Add New')); ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="table-wrap table-responsive">
                            <table class="table table-default">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $all_location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><?php echo e($data->getTranslation('city_name',$default_lang,true)); ?></td>
                                        <td><?php echo e($data->getTranslation('state_name',$default_lang,true)); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-location-delete')): ?>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover-all-lang','data' => ['url' => route('admin.product.location.delete.all.lang',$data->id)]]); ?>
<?php $component->withName('delete-popover-all-lang'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.product.location.delete.all.lang',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-location-edit')): ?>
                                                ...
                                                <a href="#"
                                                   ...
                                                   data-city_name="<?php echo e($data->getTranslation('city_name',$default_lang )); ?>"
                                                   data-state_name="<?php echo e($data->getTranslation('state_name',$default_lang )); ?>"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(__('Create Tag')); ?></h5>
                        <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
                    </div>
                    <form action="<?php echo e(route('admin.product.location.store')); ?>" method="post">
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="lang" value="<?php echo e($default_lang); ?>">
                            <div class="form-group">
                                <label for="edit_name"><?php echo e(__('City Name')); ?></label>
                                <input type="text" class="form-control" id="edit_city" name="city_name">
                            </div>

                            <div class="form-group">
                                <label for="edit_name"><?php echo e(__('State Name')); ?></label>
                            ...
                            <div class="form-group ">
                                <label for="image"><?php echo e(__('Location Image')); ?></label>
        ...
        <div class="modal fade" id="location_edit_modal" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.product.location.update')); ?>" method="post" id="location_edit_form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="update" type="submit"
                                            class="btn btn-primary"><?php echo e(__('Save Change')); ?></button>
                                </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/coupon/@core/resources/views/backend/product/location.blade.php ENDPATH**/ ?>
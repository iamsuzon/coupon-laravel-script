        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="comment-section-title section-title-style-02">
                    <h3 class="title"><?php echo e(__('Leave a Comment')); ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="btn-wrapper">
                                <button type="submit" class="btn-default" id="post-comment-btn"><?php echo e(__('Post Comment')); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <?php if(auth()->guard('admin')->guest()): ?>
        ...
        <div class="">
            <a class="review-login" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter">
                ...
                <?php echo e(__('Please login to write a comment')); ?></a>
        </div>
    <?php endif; ?>
<?php endif; ?>
...
</div><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/coupon/@core/Modules/Blog/Resources/views/frontend/blog/blog-single-variant/partials/details_write_comments_01.blade.php ENDPATH**/ ?>
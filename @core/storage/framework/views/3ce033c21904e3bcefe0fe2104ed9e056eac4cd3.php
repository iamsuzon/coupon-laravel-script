...
<?php $__env->startSection('page-title'); ?>
    <h2 class="list-item font-weight-bold"><?php echo e(__('Tags')); ?></h2>
    <h2 class="list-item font-weight-bold"><a href="<?php echo e(route('frontend.product.tag.single',$tag)); ?>"><?php echo e($tag); ?></a></h2>
...
<?php $__env->startSection('page-meta-data'); ?>
    ...
    <?php echo render_site_title($tag); ?>
            ...
            <div class="row three-column">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="single-featured-item style-01">
                        <div class="img-box">
                            <a href="<?php echo e(route_single_category(optional($product->category)->slug)); ?>" class="catg-tag top-left border-radius-15"
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/coupon/@core/resources/views/frontend/tag.blade.php ENDPATH**/ ?>
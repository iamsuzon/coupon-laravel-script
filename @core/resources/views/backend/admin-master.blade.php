...
<div class="page-container">
        ...
        <div class="header-area">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-sm-8 clearfix">
                    <div class="nav-btn pull-left" id="navbar_toggle_icon_for_mobile_device">
                        <span></span>
                        <span></span>
                        <span></span>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        {!! render_image_markup_by_attachment_id(auth()->guard('admin')->user()->image,'avatar user-thumb','','',false) !!}
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">V-{{get_static_option('site_script_version','1.0.3')}}</p>
        </div>
    </footer>
</div>

...
@section('page-title')
    <h2 class="list-item font-weight-bold"><a href="#">{{$location->city_name}}, {{$location->state_name}}</a></h2>
@endsection
...
@section('page-meta-data')
    {!! render_site_meta() !!}
    {!! render_site_title($location->city_name) !!}
@endsection
            ...
            <div class="row three-column">
                @forelse($products as $key => $product)
                    ...
                    <div class="single-featured-item style-01">
                        <div class="img-box">
                            <a href="{{route_single_category(optional($product->category)->slug)}}" class="catg-tag top-left-02 border-radius-15"

...
@section('page-title')
    ...
    <h2 class="list-item font-weight-bold"><a href="#">{{__('Edit Profile')}}</a></h2>
@endsection
    ...
    <div class="parent my-5">
        ...
        <form action="{{route('user.profile.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-4">
                    <label for="zipcode">{{__('Designation')}}</label>
                    <input type="text" class="form-control" id="designation" name="designation" value="{{$user_details->designation}}">
                </div>

                <div class="form-group col-lg-8">
                    <label for="address">{{__('Description')}}</label>
                    <textarea class="form-control description" cols="5" name="description">{!! $user_details->description !!}</textarea>
                </div>
            </div>

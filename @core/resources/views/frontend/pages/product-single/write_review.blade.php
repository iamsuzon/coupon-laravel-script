        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="comment-section-title section-title-style-02">
                    <h3 class="title">{{__('Leave a Review')}}</h3>
                    <div class="comment-section-error"></div>
                </div>

                <form action="{{route('frontend.product.review.store')}}" method="POST" class="comment-form">
                    @csrf
                    <input type="hidden" value="{{$single_product->id}}" name="product_id" id="product_id">
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="btn-wrapper">
                                <button type="submit" class="btn-default" id="post-review-btn">{{__('Post Review')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <a class="review-login" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter">
                        ...
                        {{__('Please login to write a review')}}</a>
                </div>
            </div>
        </div>
    @endguest
                                        ...
                                        <form action="{{route('user.login')}}" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                                            ...
                                            <div class="sign-in-with">
                                                @if(get_static_option('enable_facebook_login'))
                                                    <a href="{{route('login.facebook.redirect')}}" class="special-account google">
                                                        <div class="icon-box">
                                                ...
                                                @if(get_static_option('enable_google_login'))
                                                    <a href="{{route('login.google.redirect')}}" class="special-account facebook">
                                                        <div class="icon-box">

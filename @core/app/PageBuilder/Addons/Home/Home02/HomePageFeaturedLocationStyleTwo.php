...
class HomePageFeaturedLocationStyleTwo extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-02/home-2-featured-location.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $data['view_all_link'] = $this->setting_item('view_all_link');
        ...
        if(!empty($limit)){
            $data['locations'] = $all_location->where(['status' => 'publish'])->whereHas('products')
        ...
        return self::view_render('home.home_page_featured_location_style_two', $data);
    }


    public function addon_title()
    {
        return __('Home Page Featured Location: 02');
    }
}
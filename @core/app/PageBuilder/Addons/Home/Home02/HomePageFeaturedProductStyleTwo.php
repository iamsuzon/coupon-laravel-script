...
class HomePageFeaturedProductStyleTwo extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-02/home-2-featured-deal.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $all_deals = Product::with('category','brand','location','reviews')->where(['featured' => 'on'])
        ...
        return self::view_render('home.home_page_featured_deals_style_two', $data);
    }


    public function addon_title()
    {
        return __('Home Page Featured Deals: 02');
    }
}
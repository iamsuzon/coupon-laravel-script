...
class HomePageFeaturedBrandsStyleTwo extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-02/home-2-featured-brand.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $data['brands'] = Cache::remember('all_brands', 600, function () use ($order_by,$order,$limit) {
            $all_brands = ProductBrand::with('location');

            if(!empty($limit)){
                return $brands = $all_brands->where(['status' => 'publish'])
        ...
        return self::view_render('home.home_page_featured_brands_style_two', $data);
    }


    public function addon_title()
    {
        return __('Home Page Featured Brands: 02');
    }
}
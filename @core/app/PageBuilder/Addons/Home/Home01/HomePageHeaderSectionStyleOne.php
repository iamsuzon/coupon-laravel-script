...
class HomePageHeaderSectionStyleOne extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-01/home-1-header.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Image::get([
            'name' => 'shape_1',
            'label' => __('Shape Image 1'),
            'value' => $widget_saved_values['shape_1'] ?? null,
            'dimensions' => '480 x 634px'
        ]);

        $output .= Image::get([
            'name' => 'shape_2',
            'label' => __('Shape Image 2'),
            'value' => $widget_saved_values['shape_2'] ?? null,
            'dimensions' => '480 x 634px'
        ]);

        $output .= Image::get([
            'name' => 'shape_3',
            'label' => __('Shape Image 3'),
            'value' => $widget_saved_values['shape_3'] ?? null,
            'dimensions' => '480 x 634px'
        ]);
        ...
        $output .= Image::get([
            'name' => 'image_3',
            'label' => __('Image 3'),
            'value' => $widget_saved_values['image_3'] ?? null,
            'dimensions' => '480 x 634px'
        ]);
    ...
    public function frontend_render()
    {
        ...
        $data['shape_1'] = SanitizeInput::esc_html($this->setting_item('shape_1'));
        $data['shape_2'] = SanitizeInput::esc_html($this->setting_item('shape_2'));
        $data['shape_3'] = SanitizeInput::esc_html($this->setting_item('shape_3'));

        $data['image_1'] = SanitizeInput::esc_html($this->setting_item('image_1'));
        $data['image_2'] = SanitizeInput::esc_html($this->setting_item('image_2'));
        $data['image_3'] = SanitizeInput::esc_html($this->setting_item('image_3'));
        ...
        return self::view_render('home.home_page_header_style_one', $data);
    }


    public function addon_title()
    {
        return __('Home Page Header: 01');
    }
}
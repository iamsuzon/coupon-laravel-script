...
class HomePageFeaturedBrandsStyleOne extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-01/home-1-featured-brands.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $all_brands = ProductBrand::query();

        if(!empty($limit)){
            $data['brands'] = $all_brands->where(['status' => 'publish'])
        ...
        return self::view_render('home.home_page_featured_brands_style_one', $data);
    }


    public function addon_title()
    {
        return __('Home Page Featured Brands: 01');
    }
}
...
class HomePageFeaturedBrandsStyleThree extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        return self::view_render('home.home_page_featured_brands_style_three', $data);
    }


    public function addon_title()
    {
        return __('Home Page Featured Brands: 03');
    }
}
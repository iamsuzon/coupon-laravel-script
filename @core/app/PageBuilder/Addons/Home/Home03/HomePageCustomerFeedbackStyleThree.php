...
class HomePageCustomerFeedbackStyleThree extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder, RenderFrontendView;

    public function preview_image()
    {
        return 'home/home-03/home-3-customer-feedback.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::view_render('home.home_page_customer_review_style_three', $data);
    }

    public function addon_title()
    {
        return __('Customers Feedback: 03');
    }
}
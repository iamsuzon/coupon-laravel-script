...
class ImageWidget extends WidgetBase
{
    ...
    public function admin_render()
    {
        ...
        if (!empty($widget_saved_values)) {
            $image_markup = render_image_markup_by_attachment_id($widget_saved_values['single_image'], '', '', false);
    ...
    public function frontend_render()
    {
        ...
        $output .= '<div class="single-wrap"><a href="'.$image_url.'">'.render_image_markup_by_attachment_id($image_val,'footer-logo','', false).'</a></div>';

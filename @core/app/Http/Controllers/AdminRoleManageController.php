...
class AdminRoleManageController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:user-list',['only'=>['new_user','all_user']]);
        $this->middleware('permission:user-create',['only'=>['new_user_add']]);
        $this->middleware('permission:user-edit',['only'=>['user_edit','user_update']]);
        $this->middleware('permission:user-delete',['only'=>['new_user_delete']]);
    }

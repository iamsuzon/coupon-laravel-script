            ...
            if (!empty($matches[0])){
                ...
                if ($dynamic_menu_type){
                    ...
                    if ($dynamic_menu_type['query'] === 'old_lang'){
                        ...
                        $item_details = $model->usingLocale($default_lang)->where(['id' => $menu_item->pid,'status' => 'publish'])->first();
                    }
                    ...
                    if ($dynamic_menu_type['query'] === 'old_lang'){
                        ...
                        $title = optional($item_details)->getTranslation($title_param,$default_lang) ?? '';
                    }
